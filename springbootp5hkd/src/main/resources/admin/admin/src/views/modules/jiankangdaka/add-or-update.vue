<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="健康情况" prop="jiankangqingkuang">
          <el-select v-model="ruleForm.jiankangqingkuang" placeholder="请选择健康情况">
            <el-option
                v-for="(item,index) in jiankangqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="健康情况" prop="jiankangqingkuang">
	      <el-input v-model="ruleForm.jiankangqingkuang"
                placeholder="健康情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="接触史" prop="jiechushi">
          <el-select v-model="ruleForm.jiechushi" placeholder="请选择接触史">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="今日体温" prop="jinritiwen">
          <el-input v-model="ruleForm.jinritiwen" 
              placeholder="今日体温" clearable  :readonly="ro.jinritiwen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="今日体温" prop="jinritiwen">
              <el-input v-model="ruleForm.jinritiwen" 
                placeholder="今日体温" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="佩戴口罩" prop="peidaikouzhao">
          <el-select v-model="ruleForm.peidaikouzhao" placeholder="请选择佩戴口罩">
            <el-option
                v-for="(item,index) in peidaikouzhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="佩戴口罩" prop="peidaikouzhao">
	      <el-input v-model="ruleForm.peidaikouzhao"
                placeholder="佩戴口罩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="打卡日期" prop="dakariqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.dakariqi" 
                type="datetime"
                placeholder="打卡日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dakariqi" label="打卡日期" prop="dakariqi">
              <el-input v-model="ruleForm.dakariqi" 
                placeholder="打卡日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
	...
	dakariqi : false,
      ...
      ruleForm: {
        ...
        dakariqi: '',
          ...
          jiankangqingkuangOptions: [],
          jiechushiOptions: [],
          peidaikouzhaoOptions: [],
      rules: {
          zhanghao: [
          ],
          xingming: [
  ...
  created() {
	this.ruleForm.dakariqi = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jinritiwen = true;
          ...
          if(o=='peidaikouzhao'){
            this.ruleForm.peidaikouzhao = obj[o];
	    this.ro.peidaikouzhao = true;
            continue;
          }
          if(o=='dakariqi'){
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.jiankangqingkuangOptions = "健康,发热,疑似,确诊,已治愈,其他".split(',')
            this.jiechushiOptions = "是,否".split(',')
            this.peidaikouzhaoOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
