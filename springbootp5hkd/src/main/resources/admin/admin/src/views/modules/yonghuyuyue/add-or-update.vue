<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进馆日期" prop="jinguanriqi">
          <el-input v-model="ruleForm.jinguanriqi" 
              placeholder="进馆日期" clearable  :readonly="ro.jinguanriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进馆日期" prop="jinguanriqi">
              <el-input v-model="ruleForm.jinguanriqi" 
                placeholder="进馆日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="到达时间" prop="daodashijian">
          <el-select v-model="ruleForm.daodashijian" placeholder="请选择到达时间">
            <el-option
                v-for="(item,index) in daodashijianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="到达时间" prop="daodashijian">
	      <el-input v-model="ruleForm.daodashijian"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushuguanmingcheng = true;
          ...
          if(o=='jinguanriqi'){
            this.ruleForm.jinguanriqi = obj[o];
	    this.ro.jinguanriqi = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.daodashijianOptions = "上午,下午".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
